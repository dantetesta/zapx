...
// 🎯 MOSTRAR BLOCO DE OPORTUNIDADE DE NEGÓCIO (WHITE LABEL)
// true = Mostra o bloco "Comprar Sistema" (para revenda/white label)
// false = Oculta o bloco (padrão)
$mostrarOportunidadeNegocio = true;

// 📱 WHATSAPP DE CONTATO (sem espaços, com código do país)
// Formato: 5519998021956 (55 = Brasil, 19 = DDD, 99802-1956 = número)
$whatsappContato = '5519998021956';

// 📧 EMAIL DE CONTATO
$emailContato = 'dante.testa@gmail.com';
...
<head>
    ...
    <title><?php echo htmlspecialchars($companyName); ?> - Disparo em Massa WhatsApp</title>
    <meta name="description" content="Dispare mensagens em massa no WhatsApp com fotos, vídeos, áudios e documentos. Gerencie contatos com tags.">
    <meta name="keywords" content="WhatsApp Business, disparo em massa, envio em massa, mensagens whatsapp, <?php echo htmlspecialchars($companyName); ?>">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <?php if ($mostrarOportunidadeNegocio): ?>
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
                <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                    <h1 class="text-4xl font-bold text-white sm:text-5xl lg:text-6xl">
                        ...
                        com <?php echo htmlspecialchars($companyName); ?>
                    </h1>
            ...
            <div class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div class="px-6 py-8">
                        ...
                        <div class="text-center">
                            <a href="https://wa.me/<?php echo $whatsappContato; ?>?text=Olá! Tenho interesse no <?php echo htmlspecialchars($companyName); ?> - Plano Start (R$ 30/mês). Podem me ajudar?" 
                               target="_blank"
                ...
                <div class="bg-white rounded-2xl shadow-2xl overflow-hidden transform hover:scale-105 transition-transform duration-300 border-4 border-green-500 relative">
                    ...
                    <div class="px-6 py-8">
                        ...
                        <div class="text-center">
                            <a href="https://wa.me/<?php echo $whatsappContato; ?>?text=Olá! Tenho interesse no <?php echo htmlspecialchars($companyName); ?> - Plano Personal (R$ 50/mês). Podem me ajudar?" 
                               target="_blank"
                               class="whatsapp-green text-white px-6 py-3 rounded-lg text-base font-semibold hover:shadow-lg transition-all duration-300 inline-block w-full text-center">
                                <i class="fab fa-whatsapp mr-2"></i>
                                Contratar via WhatsApp
                ...
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div class="px-6 py-8">
                        ...
                        <div class="text-center">
                            <a href="https://wa.me/<?php echo $whatsappContato; ?>?text=Olá! Tenho interesse no <?php echo htmlspecialchars($companyName); ?> - Plano Business (R$ 100/mês). Podem me ajudar?" 
                               target="_blank"
                               class="whatsapp-green text-white px-6 py-3 rounded-lg text-base font-semibold hover:shadow-lg transition-all duration-300 inline-block w-full text-center">
                                <i class="fab fa-whatsapp mr-2"></i>
                                Contratar via WhatsApp
            ...
            <div id="comprar-sistema" class="mt-20 scroll-mt-20">
                <div class="bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 rounded-2xl p-8 md:p-12 max-w-4xl mx-auto border-2 border-purple-500 shadow-2xl relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <!-- CTA -->
                        <div class="text-center">
                            <a href="https://wa.me/<?php echo $whatsappContato; ?>?text=Olá! Tenho interesse em adquirir uma cópia do sistema <?php echo htmlspecialchars($companyName); ?> por R$ 297. Gostaria de mais informações." 
                               target="_blank"
                ...
                <div class="flex items-center justify-center gap-3 mb-4">
                    ...
                    <?php else: ?>
                        <img src="<?php echo APP_URL; ?>/<?php echo htmlspecialchars($companyLogo); ?>" 
                             ...
                             class="w-10 h-10 object-contain">
                    <?php endif; ?>
                    <h3 class="text-2xl font-bold text-white"><?php echo htmlspecialchars($companyName); ?></h3>
                </div>
                <p class="text-gray-400 mb-6">
                    Disparo em massa no WhatsApp para empresas
                </p>
                <div class="flex justify-center space-x-6">
                    <a href="https://wa.me/<?php echo $whatsappContato; ?>" target="_blank" class="text-gray-400 hover:text-green-500 transition">
                        <i class="fab fa-whatsapp text-2xl"></i>
                    </a>
                    <a href="mailto:<?php echo $emailContato; ?>" class="text-gray-400 hover:text-blue-500 transition">
                        <i class="fas fa-envelope text-2xl"></i>
                    </a>
                </div>
                <div class="mt-8 pt-8 border-t border-gray-700">
                    <p class="text-gray-400 text-sm">
                        © 2025 <?php echo htmlspecialchars($companyName); ?>. Todos os direitos reservados. 
