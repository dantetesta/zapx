...
<nav class="bg-white shadow-lg fixed top-0 left-0 right-0" style="z-index: 50;">
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="<?php echo APP_URL; ?>/dashboard/index" class="flex items-center gap-2">
                        ...
                        <span class="text-xl font-bold gradient-text hidden sm:block">ZAPX</span>
                    </a>
                </div>
                ...
                <div class="hidden md:ml-8 md:flex md:space-x-4">
                    ...
                    <a href="<?php echo APP_URL; ?>/users/index" 
                       class="inline-flex items-center px-3 py-2 text-sm font-medium rounded-md <?php echo (strpos($_SERVER['REQUEST_URI'], '/users') !== false) ? 'text-purple-600 bg-purple-50' : 'text-gray-700 hover:text-purple-600 hover:bg-gray-50'; ?>">
                        <i class="fas fa-users mr-2"></i>
                        Usuários
                    </a>
                    <a href="<?php echo APP_URL; ?>/instances/index" 
                       class="inline-flex items-center px-3 py-2 text-sm font-medium rounded-md <?php echo (strpos($_SERVER['REQUEST_URI'], '/instances') !== false) ? 'text-purple-600 bg-purple-50' : 'text-gray-700 hover:text-purple-600 hover:bg-gray-50'; ?>">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative">
                    ...
                    <div id="profileMenu" class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl py-2 hidden border border-gray-200" style="z-index: 9999 !important;">
                        ...
                        <a href="<?php echo APP_URL; ?>/dispatch/history" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors">
    ...
    <div id="mobile-menu" class="hidden md:hidden border-t border-gray-200">
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <?php if (isset($user['is_admin']) && $user['is_admin']): ?>
            <a href="<?php echo APP_URL; ?>/users/index" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-purple-600 hover:bg-gray-50">
                <i class="fas fa-users mr-2"></i>
                Usuários
            </a>
            <a href="<?php echo APP_URL; ?>/instances/index" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-purple-600 hover:bg-gray-50">
                <i class="fas fa-server mr-2"></i>
                Instâncias
            </a>
            <?php endif; ?>
