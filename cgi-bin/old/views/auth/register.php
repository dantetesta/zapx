    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form method="POST" action="<?php echo APP_URL; ?>/auth/register" class="bg-white rounded-xl shadow-md p-6 space-y-6">
            ...
            <div class="flex gap-4">
                <a href="<?php echo APP_URL; ?>/users/index" class="flex-1 px-6 py-3 border text-center rounded-lg">Cancelar</a>
                <button type="submit" class="flex-1 px-6 py-3 gradient-bg text-white rounded-lg">Criar Usuário</button>
            </div>
        </form>
    </div>
</div>
